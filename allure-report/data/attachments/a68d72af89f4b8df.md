...
- Name: assertion.spec.js >> assertion task incorect password
- Location: tests\assertion.spec.js:62:5
...
Locator: locator('//div[@class="show"]')
...
Call log:
  ...
  - waiting for locator('//div[@class="show"]')
    14 × locator resolved to <div id="error" class="show">Your username is invalid!</div>
       - unexpected value "Your username is invalid!"
